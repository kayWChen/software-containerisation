...
<script>
    export default {
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        axios.put('http://api-service:8081/subject/update', this.ruleForm).then(function (resp) {
                            console.log(resp)
                        })
                    } else {
        ...
        created() {
            ...
            const _this = this
            axios.get('http://api-service:8081/subject/findById/' + this.$route.query.id).then(function (resp) {
